...
public class Main {
    ...
    private static String LOGO = "\n"
            ...
            + "创建新证据：./credit new  keyStoreFileName keyStorePassword keyPassword deployAddress credit_id credit_hash  \n"
            + "发送签名：./credit send keyStoreFileName keyStorePassword keyPassword newCreditAddress credit_hash \n"
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (args[0]) {
            ...
            //newCredit
            case "new":
                //参数1为keyStoreFileName（私钥文件名），参数2为keyStorePassword，参数3为keyPassword,传入的参数需要部署的工厂合约地址,Credit_id、Credit_hash
                newCreditAddress=app.newCredit(args[1],args[2],args[3],args[4],args[5],args[6]);
            ...
            case "send":
                ...
                boolean flag = app.sendSignatureToBlockChain(args,creditData2.getCreditHash());
                if(flag){
            ...
            case "get":
                ...
                System.out.println("the creditID: " + creditData.getCreditID());
                System.out.println("the creditHash: " + creditData.getCreditHash());
